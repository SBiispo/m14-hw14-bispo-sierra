...
This project utilizes the following Bootstrap components:

1. **Navbar**:  
   - A responsive navigation bar with links to different sections of the page. It includes a toggle button for mobile devices.

2. **Grid System**:  
   - Used to create responsive columns for "About Me," "Interests," "Career Goals," and "My Hobby

3. **Cards**:  
   - Styled sections for "My Hobby" and "Career Goals."

4. **Buttons**:  
   - Added interactive buttons inside cards ("Learn More").

5. **Spacing Utilities**:  
   - Used margin and padding utilities (e.g., `mt-4`) to ensure proper spacing between sections.
